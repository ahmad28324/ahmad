...
#group 932007
#=====================================
# this programm I run it using repl.it
...
#===================================
##This  is the first function, it  returns the current time in the given timezone
...
get_current(timez)
#===================================
#This is the second function it takes a datatime with its zone in json format, And takes another
# timezone and returns the datetime of the first  in the second timezone
...
#===================================
#example for the function2   convert_dt(dt_json , new_tz)
new_tz='Europe/Amsterdam'
time_tz = timezone('Pacific/Honolulu')
start_date = datetime.now().astimezone(time_tz).strftime('%Y-%m-%dT%H:%M:%S.%f')
d = {'start_date': start_date}

dt_json=json.dumps(d)
print (d)
print (dt_json)
#convert_dt(json.dumps(d), new_tz)
#===================================
...
with make_server('', 8000, application) as httpd:
    ...
    print('note: When you stop and want to run again you have two choice:')
    print( '1- change port to before the running to 80001, 8002 ...')
    print ('2- wait 1 minute then the programm will run')
    httpd.serve_forever()
#===================================